...
public class JolokiaCheckerTest {
	...
	public static void setup() throws IOException, InstanceAlreadyExistsException,
		...
		// Find a free port for Jolokia
		ServerSocket socket = new ServerSocket(0);
		jolokiaPort = socket.getLocalPort();
		socket.close();
		
		// Setup a test MBean and start Jolokia
    ...
    public void testInvalidUserPassCombo() throws JSONException,
        ...
        try {
            ...
            new JolokiaChecker(request, getMockConfig());
